...
export const ContactForm = () => {
  ...
  return (
    <section className={`${styles.box} "py-5"`}>
      <div className="container grid md:grid-cols-2 grid-cols-1 lg:max-w-[1300px] justify-center mx-auto md:px-8 px-0 md:gap-5">
        ...
        <div className="md:h-full w-full">
              <Image
                src={img1}
                alt="img1"
                className="object-fit w-full h-full md:h-auto mx-auto mb-4"
              />
          </div>
      </div>
    </section>
